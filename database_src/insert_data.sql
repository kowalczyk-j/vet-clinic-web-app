...
INSERT INTO medical_procedure (name, description, estimate_time) VALUES
    ...
    ('Szczepienie', 'Podawanie szczepionki', '00:30:00'),
    ('Kastracja', 'Usunięcie gonad', '01:00:00'),
    ('Zdjęcie rentgenowskie', 'Diagnostyka obrazowa', '00:30:00'),
    ('USG', 'Badanie ultrasonograficzne', '00:30:00'),
    ('Zabieg chirurgiczny', 'Operacja', '02:00:00'),
    ('Wizyta kontrolna', 'Kontrola po leczeniu', '00:30:00'),
    ('Pobranie i badanie krwi', 'Diagnostyka laboratoryjna', '00:30:00'),
    ('Higienizacja uszu', 'Usuwanie woskowiny z uszu', '00:30:00'),
    ('Higienizacja stomatologiczna', 'Zabiegi związane z zębami', '00:30:00'),
    ('Zakładanie opatrunku', 'Zabezpieczanie ran i skaleczeń', '00:30:00'),
    ('Znieczulenie', 'Podawanie środka znieczulającego', '00:30:00'),
    ('Eutanazja', 'Łagodne uśpienie zwierzęcia', '00:30:00'),
    ('Rehabilitacja', 'Ćwiczenia i terapia dla zwierząt', '01:30:00'),
    ('Zabieg dentystyczny', 'Zabiegi związane z zębami', '01:00:00'),
    ('Badanie serca', 'Badanie elektrokardiograficzne', '01:00:00'),
    ('Zabieg dermatologiczny', 'Zabiegi związane ze skórą', '00:30:00'),
    ('Zabieg oczny', 'Zabiegi związane z oczami', '01:30:00'),
    ('Diagnostyka laboratoryjna', 'Badanie laboratoryjne', '01:00:00'),
    ('Zabieg ortopedyczny', 'Zabiegi związane z kośćmi i stawami', '01:00:00'),
    ('Zabieg kardiologiczny', 'Zabiegi związane z sercem', '02:00:00'),
    ('Zabieg neurologiczny', 'Zabiegi związane z układem nerwowym', '02:00:00'),
...
INSERT INTO employee (position_id, name, surname, phone_number, address, salary, employment_date, bonus) VALUES
    (1, 'Janusz', 'Kowalczewski', '123456789', 'ul. Przykładowa 1, 00-631 Warszawa', 4200.00, '2020-01-15', 100.00),
    (5, 'Anna', 'Nowaczewska', '987654321', 'ul. Testowa 2, 00-631 Warszawa', 6800.00, '2021-05-10', 300.00),
...
-- 10 - Harmonogram pracowników (Dni są numerowane od 1 (niedziela) do 7 (sobota))
...
INSERT INTO appointment (vet_id, room_id, animal_id, date, time) VALUES
    (2, 1, 1, '2023-06-23', '11:30:00'),
    (4, 2, 2, '2023-07-17', '13:30:00'),
    (2, 1, 3, '2023-06-28', '15:45:00'),
    (1, 3, 4, '2023-06-27', '13:15:00'),
    (4, 2, 5, '2023-08-22', '16:00:00'),
    (1, 3, 6, '2023-07-29', '14:30:00'),
    (2, 1, 7, '2023-06-24', '11:45:00'),
    (5, 3, 8, '2023-06-20', '17:30:00'),
    (3, 2, 9, '2023-08-03', '12:15:00'),
    (3, 3, 10, '2023-06-20', '11:00:00'),
    (2, 1, 11, '2024-02-17', '14:00:00'),
    (4, 2, 12, '2023-06-19', '16:45:00'),
    (2, 1, 13, '2023-06-23', '14:30:00'),
    (1, 3, 14, '2023-06-28', '12:15:00'),
    (4, 2, 15, '2023-06-20', '16:30:00'),
    (1, 3, 16, '2023-07-12', '15:45:00'),
    (2, 4, 17, '2023-07-28', '14:30:00'),
    (1, 3, 18, '2023-08-16', '16:15:00'),
    (3, 2, 1, '2023-08-03', '12:30:00'),
    (2, 3, 2, '2023-07-20', '14:00:00'),
    (2, 1, 5, '2023-07-07', '15:45:00'),
    (4, 2, 6, '2023-06-19', '16:30:00'),
    (2, 1, 8, '2023-07-07', '13:30:00'),
    (1, 3, 1, '2023-08-12', '17:00:00'),
    (4, 2, 16, '2023-06-26', '13:00:00'),
    (1, 3, 12, '2024-03-02', '14:15:00'),
    (2, 5, 13, '2023-06-24', '15:30:00'),
    (5, 4, 15, '2023-07-20', '18:00:00'),
    (2, 2, 11, '2023-12-12', '12:00:00'),
    (2, 3, 2, '2023-11-23', '16:30:00');
