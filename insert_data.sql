...
INSERT INTO owner (name, surname, address, phone_number, pesel) VALUES
    ...
    ('Alicja', 'Grabowska', 'ul. Kwiatowa 20/12, 00-644 Warszawa', '782923742', '12345678901'),
    ('Robert', 'Witkowski', 'ul. Miodowa 11, 00-631 Warszawa', '718323864', '23456789012'),
    ('Dominika', 'Dąbrowska', 'ul. Słoneczna 6/21c, 00-631 Warszawa', '593323853', '34567890123'),
    ('Marcin', 'Kołodziej', 'ul. Parkowa 9/603, 12-200 Pisz', '539235382', '45678901234');
...
INSERT INTO appointment (vet_id, room_id, animal_id, date, time) VALUES
    (2, 1, 1, '2022-12-15', '11:30:00'),
    (4, 2, 2, '2022-11-10', '12:30:00'),
    (2, 1, 3, '2022-10-05', '15:45:00'),
    (1, 3, 4, '2022-09-20', '13:15:00'),
    (4, 2, 5, '2022-08-18', '16:00:00'),
    (1, 3, 6, '2022-07-22', '14:30:00'),
    (2, 1, 7, '2022-06-12', '11:45:00'),
    (5, 3, 8, '2022-05-05', '17:30:00'),
    (3, 2, 9, '2022-04-28', '12:15:00'),
    (3, 3, 10, '2022-03-17', '11:00:00'),
    (2, 1, 11, '2022-02-10', '14:00:00'),
    (4, 2, 12, '2022-01-05', '16:45:00'),
    (2, 1, 13, '2021-12-15', '11:30:00'),
    (1, 3, 14, '2021-11-22', '12:15:00'),
    (4, 2, 15, '2021-10-30', '13:30:00'),
    (1, 3, 16, '2021-10-05', '15:45:00'),
    (2, 4, 17, '2021-09-20', '14:30:00'),
    (1, 3, 18, '2021-08-10', '16:15:00'),
    (3, 2, 1, '2021-07-28', '12:30:00'),
    (3, 3, 2, '2021-07-15', '14:00:00'),
    (2, 1, 5, '2021-06-30', '11:45:00'),
    (4, 2, 6, '2021-06-10', '16:30:00'),
    (2, 1, 8, '2021-05-20', '13:30:00'),
    (1, 3, 1, '2021-04-05', '17:00:00'),
    (4, 2, 16, '2021-03-15', '12:45:00'),
    (1, 3, 12, '2021-02-25', '14:15:00'),
    (2, 5, 13, '2021-02-05', '15:30:00'),
    (5, 4, 15, '2021-01-12', '18:00:00'),
    (3, 2, 11, '2020-12-18', '12:00:00'),
    (3, 3, 2, '2020-11-25', '16:30:00');
...
INSERT INTO room_medical_equipment (equipment_id, room_id, last_inspection, next_inspection) VALUES
    ...
    (6, 1, '2023-06-20', '2024-06-20'),
    (7, 1, '2023-07-25', '2024-07-25'),
    (1, 2, '2023-08-22', '2024-08-22'),
    (2, 3, '2023-09-30', '2024-09-30'),
    (3, 4, '2023-10-25', '2024-10-25'),
    (4, 5, '2023-11-28', '2024-11-28'),
    (5, 5, '2023-12-15', '2024-12-15'),
    (6, 3, '2024-01-10', '2025-01-10'),
